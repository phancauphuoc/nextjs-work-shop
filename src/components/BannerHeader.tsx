...
const BannerHeader = () => {
    return (
        <>
            ...
            {/* Banner area end */}
            {/* Service area start */}
            <section className="furniture-service pt-100 pb-100">
                <div className="container">
                    <div className="row g-4">
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div className="furniture-service__item">
                                <div className="fsr-icon">
                                    <svg
                                        width={80}
                                        height={63}
                                        viewBox="0 0 80 63"
                                        ...
                                        <defs>
                                            <clipPath id="clip0_210_11">
                                                <rect
                                                    ...
                                                    height="55.1249"
                                                    fill="white"
                                                    transform="translate(0 0.929932)"
                                                />
                                            </clipPath>
                                        </defs>
                                    </svg>
