                                                ...
                                                <div className="product-item furniture__product">
                                                    ...
                                                    <div className="product-thumb theme-bg-2">
                                                        <a href="product-details.html">
                                                            <img
                                                                src="assets/imgs/furniture/product/product1.png"
                                                                alt=""
                                                            />
                                                        </a>
                                            ...
                                            <div className="swiper-slide">
                                                <div className="product-item furniture__product">
                                                    <div className="product-thumb theme-bg-2">
                                                        <a href="product-details.html">
                                                            <img
                                                                src="assets/imgs/furniture/product/product2.png"
                                                                alt=""
                                                            />
                                                        </a>
                                                        <div className="product-action-item">
                                            ...
                                            <div className="swiper-slide">
                                                <div className="product-item furniture__product">
                                                    ...
                                                    <div className="product-thumb theme-bg-2">
                                                        <a href="product-details.html">
                                                            <img
                                                                src="assets/imgs/furniture/product/product3.png"
                                                                alt=""
                                                            />
                                                        </a>
                                                        <div className="product-action-item">
                                                    ...
                                                    <div className="product-content">
                                                        ...
                                                        <div className="product-price">
                                                            <span className="product-new-price">USD 200.00</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="swiper-slide">
                                                <div className="product-item furniture__product">
                                                    <div className="product-thumb theme-bg-2">
                                                        <a href="product-details.html">
                                                            <img
                                                                src="assets/imgs/furniture/product/product4.png"
                                                                alt=""
                                                            />
                                                        </a>
                                                        <div className="product-action-item">
                                            ...
                                            <div className="swiper-slide">
                                                <div className="product-item furniture__product">
                                                    <div className="product-thumb theme-bg-2">
                                                        <a href="product-details.html">
                                                            <img
                                                                src="assets/imgs/furniture/product/product5.png"
                                                                alt=""
                                                            />
                                                        </a>
                                                        <div className="product-action-item">
