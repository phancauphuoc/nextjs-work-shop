...
import { getSatate, useAppDispatch } from '@/hooks/useStore'
import { getListFeaturedProduct } from '@/services/redux/slices/feature-product/action';

const Topsale = () => {
    const dispatch = useAppDispatch();
    const { featureProduct } = getSatate('feature');

    console.log('first', featureProduct);
                    ...
                    <div className="row g-4">
                        <div className="col-lg-6">
                            <a
                                ...
                                style={{ backgroundImage: 'url(assets/imgs/furniture/product/off-01.png)' }}
                            >
                                <span className="fo-discount">GET 30% OFF</span>
                        ...
                        <div className="col-lg-6">
                            <a
                                ...
                                style={{ backgroundImage: 'url(assets/imgs/furniture/product/off-02.png)' }}
                            >
                                <span className="fo-discount">GET 15% OFF</span>
                                <h3 className="text-capitalize">
                                    Brasslegged <br />
                                    Armchair
                                </h3>
                                <div className="solid-btn mt-30">
                                    Buy Now
                                    <span>
                                        <i className="fa-reguladiva-angle-right" />
                                    </span>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="col-xxl-12">
                            <div className="swiper furuniture-active">
                                <div className="swiper-wrapper">
                                    ...
                                    >
                                        {
                                            featureProduct && featureProduct.map((item: any, index: any) => {
                                                return (
                                                    <SwiperSlide>
                                                        <div className="swiper-slide" id={index}>
                                                            <div className="product-item furniture__product">
                                                                <div className="product-badge">
                                                                    <span className="product-trending">11% off</span>
                                                                </div>
                                                                ...
                                                                <div className="product-content">
                                                                    ...
                                                                    <div className="product-price">
                                                                        <span className="product-new-price">USD {item.price}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
