                                ...
                                <div className="row g-4">
                                        ...
                                        <div className="product-item furniture__product">
                                            ...
                                            <div className="product-content">
                                                <h4 className="product-title">
                                                    <a href="product-details.html">stylish grey chair</a>
                                                </h4>
                                    ...
                                    <div className="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                        <div className="product-item furniture__product">
                                            ...
                                            <div className="product-content">
                                                <h4 className="product-title">
                                                    <a href="product-details.html">seater gray sofa</a>
                                                </h4>
                                                <div className="user-rating mb-1">
                                                    <i className="far fa-star" />
                                                    <i className="far fa-star" />
                                    ...
                                    <div className="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                        <div className="product-item furniture__product">
                                            ...
                                            <div className="product-content">
                                                <h4 className="product-title">
                                                    <a href="product-details.html">wooden chair</a>
                                                </h4>
                                                <div className="user-rating mb-1">
                                                    <i className="far fa-star" />
                                                    <i className="far fa-star" />
                                    ...
                                    <div className="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                        <div className="product-item furniture__product">
                                            <div className="product-thumb theme-bg-2">
                                                <a href="product-details.html">
                                                    <img
                                                        src="assets/imgs/furniture/product/product6.png"
                                                        alt=""
                                                    />
                                                </a>
                                                <div className="product-action-item">
                                    ...
                                    <div className="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                        <div className="product-item furniture__product">
                                            ...
                                            <div className="product-thumb theme-bg-2">
                                                <a href="product-details.html">
                                                    <img
                                                        src="assets/imgs/furniture/product/product7.png"
                                                        alt=""
                                                    />
                                                </a>
                                                <div className="product-action-item">
                                            ...
                                            <div className="product-content">
                                                <h4 className="product-title">
                                                    <a href="product-details.html">chair nobody armchair</a>
                                                </h4>
                                                <div className="user-rating mb-1">
                                                    <i className="far fa-star" />
                                                    <i className="far fa-star" />
                                    ...
                                    <div className="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                        <div className="product-item furniture__product">
                                            <div className="product-thumb theme-bg-2">
                                                <a href="product-details.html">
                                                    <img
                                                        src="assets/imgs/furniture/product/product8.png"
                                                        alt=""
                                                    />
                                                </a>
                                                <div className="product-action-item">
                                            ...
                                            <div className="product-content">
                                                <h4 className="product-title">
                                                    <a href="product-details.html">realistic sofa</a>
                                                </h4>
                                                <div className="user-rating mb-1">
                                                    <i className="far fa-star" />
                                                    <i className="far fa-star" />
